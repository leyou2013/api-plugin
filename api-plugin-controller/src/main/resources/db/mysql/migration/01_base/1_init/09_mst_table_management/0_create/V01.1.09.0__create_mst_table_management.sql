...
CREATE TABLE `mst_table_management` 
     ( `table_management_serial_id`  BIGINT           AUTO_INCREMENT UNIQUE NOT NULL COMMENT 'シリアルID' 
     ...
     , `not_null_flag`               TINYINT DEFAULT 0                      NOT NULL COMMENT '必須チェックフラグ	画面での登録、更新時の必須チェックを表すフラグ。0：任意、1：必須' 
